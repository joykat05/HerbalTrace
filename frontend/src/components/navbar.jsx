...
function Navbar({ dark, setDark }) {
  ...
  return (
    <div
      ...
      className="bg-green-300/90 dark:bg-green-900/90 text-green-800 dark:text-green-200 p-2 max-md:p-1  flex items-center justify-between rounded-4xl font-prompt"
    >
      {/* LEFT */}
